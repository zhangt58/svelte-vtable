...
{#if open}
  ...
  >
    <div
      class="vtable-modal-panel bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-sm sm:max-w-2xl lg:max-w-4xl xl:max-w-5xl pointer-events-auto overflow-hidden"
    >
      <div
