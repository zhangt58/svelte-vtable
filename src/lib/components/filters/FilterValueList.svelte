        ...
        {#each virtualSlice.slice as value, idx (idx)}
          ...
          >
            <input
              ...
              class="w-4 h-4 shrink-0 cursor-pointer rounded border-2 border-gray-300 dark:border-gray-500 bg-white dark:bg-gray-700 checked:bg-blue-500 checked:border-blue-500 dark:checked:bg-sky-400 dark:checked:border-sky-400 focus:ring-1 focus:ring-blue-500 dark:focus:ring-sky-400"
            />
            <span
